...
# 使用最新的Media ID
media_id = "qDRdQP61cFoGHWZo0l3GcG2I58mxZsZnrAnTzOEUkCaiuLK0QUlIoU39Y-xPn1wO"
    ...
    if "data" in data and "content" in data["data"]:
        ...
        if news_item:
            ...
            checks = {
                ...
                "<table>标签": article_html.find("<table"),
                "background-color": article_html.find("background-color"),
            }
            ...
            # 保存完整HTML用于检查
            output_file = "D:/自动化生产动漫工具/comic-generator/output/latest_draft_content.html"
            with open(output_file, 'w', encoding='utf-8') as f:
                f.write("<!DOCTYPE html><html><head><meta charset='UTF-8'><title>最新草稿内容</title></head><body style='background: #f5f5f5; padding: 20px;'>")
